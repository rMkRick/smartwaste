...
router.put('/:id/waypoints',    verificarToken, soloRoles(3, 4), rutaController.actualizarWaypoints); // supervisor puede editar
router.delete('/:id',      verificarToken, soloRoles(3), rutaController.eliminar);          // CU12
router.post('/asignar',    verificarToken, soloRoles(3, 4), rutaController.asignar);        // CU12
